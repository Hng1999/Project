...
<div class="container" id="scheduleContainer" style="display: none;">
    <h1>Bus Schedule</h1>
    <table border="2px #ddd" cellspacing="2" cellpadding="2"> 
        <tr> 
            <td> <font face="Arial">No</font> </td> 
            <td> <font face="Arial">Bus Type</font> </td>
            <td> <font face="Arial">Route ID</font> </td> 
            <td> <font face="Arial">First Bus</font> </td>
            <td> <font face="Arial">Morning Peak Hour</font> </td>
            <td> <font face="Arial">Evening Peak Hour</font> </td>
            <td> <font face="Arial">Last Bus</font> </td>
...
<div class="container-nav" id="transport">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade" id="popular">
            <ul class="transport-links">
                <li><a href="MRT_Bus.html"><h4>MRT BUS</h4></a></li>
                <li><a href="LRT_Bus.html"><h4>LRT BUS</h4></a></li>
            </ul>
        </div>
